...
DIFFUSE_POSITION_RATIO = 0.10       # ★V4.5★ 扩散期建仓的单票仓位（扩散期入场天然滞后 → 半仓）
...
TRAIL_PCT = 0.10                    # ★V4.5★ 移动止盈回撤比例（原 0.08；8% 相对 3% 武装线过紧）
...
MAX_CANDIDATES = 6                  # ★V4.5★ 每日候选上限（原 10）；配合每日最多建仓 2 笔降频
