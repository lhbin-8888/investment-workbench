...
版本：★山西PTrade V1.2★（与国金PTrade_三层量化策略.py 同逻辑，仅券商适配）

★V1.2 修复（对应《回测复盘_山西PTrade_20260922.md》D9~D13，首跑真下单模式实测）：
...
def initialize(context):
    ...
    log.info("[初始化] ★山西PTrade V1.2★ 三层策略 | 标的%d | L1=%.0f%% L2=%.0f%% | TRADE=%s" %
