# -*- coding: utf-8 -*-
"""
热点早盘001 V4.10 —— 离线校验器（不依赖 PTrade 平台）
...
覆盖范围：
  ...
  3) ★核心★ monitor_risk 赢家"浮盈回撤锁利"(③b) 分支：赢家自 +30% 回撤到 +22%
     (≥8pp) 必须触发锁利清仓；
...
_CANDIDATES = [
    os.path.join(_HERE, "热点早盘001_V4.10.py"),
    os.path.normpath(os.path.join(
        _HERE, "..", "..", "06-投资策略分析", "策略回测",
        "热点早盘001", "热点早盘001_V4.10.py")),
    r"D:\投研工作台\06-投资策略分析\策略回测\热点早盘001\热点早盘001_V4.10.py",
]
...
print("-" * 72)
print("[测试 1] initialize 冒烟 & V4.10 新增状态字段")
try:
